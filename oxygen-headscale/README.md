...
2. Navigate to: `apps → oxygen-headscale`.  
...
1. Go to the folder: `apps → oxygen-headscale → config`.  
...
```bash
sudo docker exec -it oxygen-headscale_headscale_1 headscale apikeys create
```
